/**
 * SiteFooter.tsx — the `.site-foot` footer (static React, ships no client JS).
 *
 * Shows: Twitter, LinkedIn, RSS social links + the dark/light theme toggle.
 * The `site-foot-divider` appears only on post pages. Secondary navigation is
...
const socialLinkClass =
  'site-foot-social-link inline-flex items-center text-secondary-text transition-colors hover:text-primary-text [&_.icon]:h-[25px] [&_.icon]:w-[25px]';

export default function SiteFooter({ isPost = false }: Props) {
  return (
    <footer className="site-foot no-menu site-outer mt-auto whitespace-nowrap py-[2rem] text-secondary-text">
      <div className="site-foot-inner flex flex-col items-center gap-[24px] p-0">
        <div className="site-foot-bottom mt-[2rem] flex flex-col items-center gap-[1rem]">
          {isPost && <div className="site-foot-divider mb-[.5rem] block h-[2px] w-[400px] rounded-[1px] bg-light-gray"></div>}
          <div className="site-foot-social flex justify-center gap-[1rem]">
            {SITE.social.twitter && (
