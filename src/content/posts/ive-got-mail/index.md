---
title: I’ve got Mail!
date: '2022-05-10T18:48:41.000Z'
updatedDate: '2026-06-18T23:45:52.000Z'
author: oz
description: I've decided to start using a custom email service - here's how, and why.
image: featured.jpg
tags:
  - Data
  - Web
...
![Source: Justin Morgan, Unsplash](gmail-inbox-laptop.jpg)
...
![](fastmail-signup-custom-domain.png)
...
![](fastmail-check-now-button.png)

And ask Fastmail to check if we did everything right:

![](fastmail-domain-verified.png)

And…Victory!

![](first-test-email-received.png)

And after trying - it works!

![](fastmail-import-providers.png)
...
![Source: Unsplash](orange-at-symbol-sign.jpg)
*Source: Unsplash*
