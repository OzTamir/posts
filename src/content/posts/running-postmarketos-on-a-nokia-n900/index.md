...
date: '2020-07-24T17:21:36.000Z'
updatedDate: '2026-06-18T23:45:48.000Z'
author: oz
description: My advantures trying to install postmarketOS on a Nokia N900
image: featured.png
tags:
  - Technical
  - Linux
...
![Dude where's my N900?](pmos-release-channel-select.png)
...
![rsyncing to the incorrect path on purpose](rsync-pmos-packages-terminal.png)
*rsyncing to the incorrect path on purpose*

![](pmbootstrap-local-http-server.png)
...
![](n900-uboot-install-details.png)

![](n900-maemo-terminal.png)

Amazing. One boot later, and…

![Booting...](n900-linux-boot-log.gif)
*Booting...*

![Victory!](n900-postmarketos-boot-closeup.jpeg)
*Victory!*
