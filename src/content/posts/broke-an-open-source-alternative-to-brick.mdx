...
featureImage: /content/images/posts/broke-an-open-source-alternative-to-brick/featured.jpeg
---
...
<Figure src="posts/broke-an-open-source-alternative-to-brick/3d-printed-case-prototypes.jpeg" alt="It took multiple tries, but I'm really happy with the end product" caption={"<span style=\"white-space: pre-wrap;\">It took multiple tries, but I'm really happy with the end product</span>"} />
...
<Figure src="posts/broke-an-open-source-alternative-to-brick/claude-writing-swiftui-code.png" alt="" />

Working with Claude was great - I was quickly able to put a basic PoC that allowed me to demonstrate that the app worked.

<Figure src="posts/broke-an-open-source-alternative-to-brick/broke-app-poc-screens.png" alt="" caption={"<span style=\"white-space: pre-wrap;\">The Proof of concept design</span>"} />
...
<Figure src="posts/broke-an-open-source-alternative-to-brick/xcode-broke-app-with-claude.png" alt="" />
...
<Figure src="posts/broke-an-open-source-alternative-to-brick/broke-icon-color-variants.png" alt="" />

This is how the final experience looks like:

<Video src="posts/broke-an-open-source-alternative-to-brick/iphone-nfc-scan-ready.mp4" poster="posts/broke-an-open-source-alternative-to-brick/iphone-nfc-scan-ready-poster.png" />
