...
<Figure src="2024/08/IMG_3457.jpeg" alt="It took multiple tries, but I'm really happy with the end product" caption={"<span style=\"white-space: pre-wrap;\">It took multiple tries, but I'm really happy with the end product</span>"} />
...
<Figure src="2024/08/DraggedImage.png" alt="" />

Working with Claude was great - I was quickly able to put a basic PoC that allowed me to demonstrate that the app worked.

<Figure src="2024/08/poc.png" alt="" caption={"<span style=\"white-space: pre-wrap;\">The Proof of concept design</span>"} />
...
<Figure src="2024/08/Screenshot-2024-08-23-at-10.46.36.png" alt="" />
...
<Figure src="2024/08/DraggedImage.492185d805134a97b29739c7e60516c9.png" alt="" />

This is how the final experience looks like:

<Video src="2024/08/Broke.mp4" poster="2024/08/Screenshot-2024-08-24-at-19.54.16.png" />
