...
featureImage: /content/images/posts/ive-got-mail/featured.jpg
...
<Figure src="posts/ive-got-mail/gmail-inbox-laptop.jpg" alt="Source: Justin Morgan, Unsplash" caption="Source: Justin Morgan, Unsplash" />
...
<Figure src="posts/ive-got-mail/fastmail-signup-custom-domain.png" alt="" />
...
<Figure src="posts/ive-got-mail/fastmail-dns-setup-instructions.png" alt="" />

Let’s do that! From Hover’s control panel:

<Figure src="posts/ive-got-mail/mx-records-table.png" alt="" />

The next thing is to set a bunch of other records:

<Figure src="posts/ive-got-mail/spf-cname-dns-records.png" alt="" />
...
<Figure src="posts/ive-got-mail/fastmail-check-now-button.png" alt="" />

And ask Fastmail to check if we did everything right:

<Figure src="posts/ive-got-mail/fastmail-domain-verified.png" alt="" />

And…Victory!

<Figure src="posts/ive-got-mail/first-test-email-received.png" alt="" />

And after trying - it works!

<Figure src="posts/ive-got-mail/fastmail-import-providers.png" alt="" />
...
<Figure src="posts/ive-got-mail/import-gmail-options.png" alt="" />

And not only would they import historical information, but they’ll also set up forwarding for future emails!

<Figure src="posts/ive-got-mail/gmail-import-completed.png" alt="" />
...
<Figure src="posts/ive-got-mail/gmail-import-progress.png" alt="" />
...
<Figure src="posts/ive-got-mail/orange-at-symbol-sign.jpg" alt="Source: Unsplash" caption="Source: Unsplash" />
