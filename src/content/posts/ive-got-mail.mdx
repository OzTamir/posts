...
<Figure src="2022/05/justin-morgan-D2TZ-ashGzc-unsplash.jpg" alt="Source: Justin Morgan, Unsplash" caption="Source: Justin Morgan, Unsplash" />
...
<Figure src="2022/05/DraggedImage.png" alt="" />
...
<Figure src="2022/05/Screen-Shot-2022-05-10-at-20.39.26.png" alt="" />

Let’s do that! From Hover’s control panel:

<Figure src="2022/05/DraggedImage-1.png" alt="" />

The next thing is to set a bunch of other records:

<Figure src="2022/05/DraggedImage-2.png" alt="" />
...
<Figure src="2022/05/DraggedImage-3.png" alt="" />

And ask Fastmail to check if we did everything right:

<Figure src="2022/05/DraggedImage-4.png" alt="" />

And…Victory!

<Figure src="2022/05/DraggedImage-5.png" alt="" />

And after trying - it works!

<Figure src="2022/05/DraggedImage-6.png" alt="" />
...
<Figure src="2022/05/DraggedImage-8.png" alt="" />
...
<Figure src="2022/05/onlineprinters-oIpJ8koLx_s-unsplash.jpg" alt="Source: Unsplash" caption="Source: Unsplash" />
