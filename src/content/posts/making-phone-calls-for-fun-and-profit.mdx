...
featureImage: /content/images/posts/making-phone-calls-for-fun-and-profit/featured.jpg
...
<Figure src="posts/making-phone-calls-for-fun-and-profit/robocall-robot-duplicate.jpg" alt="" />
...
<Figure src="posts/making-phone-calls-for-fun-and-profit/twilio-logo-splash.jpg" alt="" />
...
<Figure src="posts/making-phone-calls-for-fun-and-profit/twilio-project-dashboard.png" alt="" />

Using these two, it is incredibly easy to call a number with a message:

<Figure src="posts/making-phone-calls-for-fun-and-profit/twilio-python-call-code.png" alt="" />
...
<Figure src="posts/making-phone-calls-for-fun-and-profit/configuration-class-code.png" alt="" />
...
<Figure src="posts/making-phone-calls-for-fun-and-profit/telegram-twilio-mode-code.png" alt="" />
...
<Figure src="posts/making-phone-calls-for-fun-and-profit/twiml-voice-response-code.png" alt="" />
...
<Figure src="posts/making-phone-calls-for-fun-and-profit/call-function-code.png" alt="" />
...
<Figure src="posts/making-phone-calls-for-fun-and-profit/website-watcher-incoming-calls.jpeg" alt="" />
