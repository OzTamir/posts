...
featureImage: /content/images/posts/wolt-watcher/featured.jpg
---
...
<Figure src="posts/wolt-watcher/restaurant-closed-error.jpg" alt="" />
...
<Video src="posts/wolt-watcher/telegram-bot-demo.mp4" autoplay title="Telegram bot replying to a Wolt order query" />
