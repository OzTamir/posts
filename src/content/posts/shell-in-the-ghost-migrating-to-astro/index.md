...
author: oz
description: Why I ditched Ghost for a static Astro site, and the malware I found on the way out.
tags:
  - Security
  - Technical
  - Astro
...
![A terminal mid Ghost update: sudo systemctl commands and ghost service status showing the blog service active and running.](updating-ghost.png)
*My last-ever Ghost update.*
...
Last week I built myself [a new site](https://talks.oztamir.com) to host and share my public-speaking stuff.
...
Luckily, Astro has a feature called [islands](https://docs.astro.build/en/concepts/islands/): tiny bits of JavaScript, shipped only where needed, which let the site eat the cake and have it too.
...
![Claude's security finding: every one of the 41 posts has an identical obfuscated codeinjection_foot that decodes to malware, injecting a remote script on every page.](claude-malware-alert.png)
*Not the way you want to find out.*
...
![The stored malware: an obfuscated, self-executing script that base64-decodes a URL and injects it as a remote script, guarded by a localStorage flag so it runs once per visitor.](malware-payload.png)
*Sitting in the footer of every single post.*
...
Cloudflare actually wrote up a good framing of this they call ["agent readiness"](https://blog.cloudflare.com/agent-readiness/): the idea that a modern site should present itself cleanly to machines, not only people. There's even a checker, [isitagentready.com](https://isitagentready.com), that audits your site against a pile of emerging standards.

I ran my freshly-migrated blog through it and, naturally, set out to turn every red X green.

![Agent-readiness scan of posts.oztamir.com: overall score 50, Level 4 'Agent-Integrated', with Discoverability 75, Content 100, Bot Access Control 100, API/Auth/MCP/Skill Discovery 14, and Commerce not checked.](agent-readiness-score.png)
*Where I landed: 'Agent-Integrated.'*
