...
<Figure src="2024/02/9820AF45-B2E1-470F-8AA8-EA99AAC9BF77_1_105_c.jpeg" alt="" />
...
<Figure src="2024/02/DraggedImage.png" alt="Image credit: esp32io.com - https://esp32io.com/tutorials/esp32-door-sensor" caption={"Image credit: esp32io.com - <a href=\"https://esp32io.com/tutorials/esp32-door-sensor\">https://esp32io.com/tutorials/esp32-door-sensor</a>"} />
...
<Figure src="2024/02/7F293E63-1E74-468B-9BB2-37488C480B27.jpg" alt="" />
...
<Figure src="2024/02/ezgif-3-ffcd7e0f6b.gif" alt="Note the red light blink - indicating that an event was logged" caption="Note the red light blink - indicating that an event was logged" />

Writing the automation was also very easy:

<Figure src="2024/02/DraggedImage-1.png" alt="" />
...
<Figure src="2024/02/DraggedImage-2.png" alt="" />
...
<Figure src="2024/02/ezgif-3-55864f3bc8.gif" alt="" />
...
<Figure src="2024/02/DraggedImage-3.png" alt="" />
...
<Figure src="2024/02/DraggedImage-4.png" alt="" />
...
<Figure src="2024/02/BE8711AD-9CD0-4943-9E53-A5C45E5023F9.jpg" alt="ESPresense base station at my office" caption="ESPresense base station at my office" />

<Figure src="2024/02/89493C39-BEB6-4779-B9C7-B5C843297DD0.jpg" alt="ESPresense base station at the room with Lychee’s sandbox" caption="ESPresense base station at the room with Lychee’s litter box" />
...
<Figure src="2024/02/DraggedImage-5.png" alt="Setting the MQTT information in the base station configuration screen" caption="Setting the MQTT information in the base station configuration screen" />
...
<Figure src="2024/02/DraggedImage-6.png" alt="Example - My phone data in the MQTT broker" caption="Example - My phone data in the MQTT broker" />
...
<Figure src="2024/02/DraggedImage-7.png" alt="" />
...
<Figure src="2024/02/DraggedImage-8.png" alt="" />
...
<Figure src="2024/02/IMG_6542.png" alt="" caption="Sad prototype is sad :(" />
...
<Figure src="2024/02/A5DE46EF-3557-42D9-8677-C3FD23794F92_1_105_c.jpeg" alt="" />
...
<Figure src="2024/02/DraggedImage-9.png" alt="" />

To test it, I forced an update via the OpenEPaperLink interface:

<Figure src="2024/02/DraggedImage-10.png" alt="" />

And, like magic - everything came together and I got this result:

<Figure src="2024/02/668B7F02-E578-4C5A-9A47-57FE28589DBC_1_102_a.jpeg" alt="" />
