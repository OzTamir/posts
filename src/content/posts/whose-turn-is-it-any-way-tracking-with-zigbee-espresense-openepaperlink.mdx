...
<Figure src="posts/whose-turn-is-it-any-way-tracking-with-zigbee-espresense-openepaperlink/litter-box-sensor-demo.gif" alt="Note the red light blink - indicating that an event was logged" caption="Note the red light blink - indicating that an event was logged" />
...
<Figure src="posts/whose-turn-is-it-any-way-tracking-with-zigbee-espresense-openepaperlink/espresense-tracking-demo.gif" alt="" />
