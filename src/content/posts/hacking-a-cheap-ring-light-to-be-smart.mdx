...
featureImage: /content/images/posts/hacking-a-cheap-ring-light-to-be-smart/featured.png
---
...
<Figure src="posts/hacking-a-cheap-ring-light-to-be-smart/amazon-ring-light-listing.png" alt="" />
...
<Figure src="posts/hacking-a-cheap-ring-light-to-be-smart/ring-light-on-desk.png" alt="" />
...
<Figure src="posts/hacking-a-cheap-ring-light-to-be-smart/original-ring-light-controller.png" alt="" />

To get things started, I used a screwdriver to open the controller:

<Figure src="posts/hacking-a-cheap-ring-light-to-be-smart/controller-jack-plug.png" alt="" />

<Figure src="posts/hacking-a-cheap-ring-light-to-be-smart/controller-pcb-buttons.png" alt="" />

<Figure src="posts/hacking-a-cheap-ring-light-to-be-smart/controller-pcb-open.png" alt="" />
...
<Figure src="posts/hacking-a-cheap-ring-light-to-be-smart/pwm-duty-cycle-diagram.png" alt="" />
...
<Figure src="posts/hacking-a-cheap-ring-light-to-be-smart/pcb-in-helping-hands.png" alt="" />

<Figure src="posts/hacking-a-cheap-ring-light-to-be-smart/desoldered-pcb-wires.png" alt="" />
...
<Figure src="posts/hacking-a-cheap-ring-light-to-be-smart/crimping-tool.png" alt="" />

<Figure src="posts/hacking-a-cheap-ring-light-to-be-smart/wires-spliced-into-ring.png" alt="" />
...
<Figure src="posts/hacking-a-cheap-ring-light-to-be-smart/chatgpt-wiring-prompt.png" alt="" />

Sonnet did not disappoint. It gave me not only the code for the ESP, but also a wiring diagram, which came in really handy!

<Figure src="posts/hacking-a-cheap-ring-light-to-be-smart/chatgpt-esp32-wiring-diagram.png" alt="" />
...
<Figure src="posts/hacking-a-cheap-ring-light-to-be-smart/chatgpt-wire-role-discovery.png" alt="" />

<Figure src="posts/hacking-a-cheap-ring-light-to-be-smart/chatgpt-webserver-code.png" alt="" />
...
<Figure src="posts/hacking-a-cheap-ring-light-to-be-smart/esp32-web-control-sliders.png" alt="" />

The UI was simple, but it did the trick:

<Figure src="posts/hacking-a-cheap-ring-light-to-be-smart/chatgpt-dual-led-discovery.png" alt="" />
...
<Figure src="posts/hacking-a-cheap-ring-light-to-be-smart/web-ui-on-monitor.png" alt="" />
...
<Video src="posts/hacking-a-cheap-ring-light-to-be-smart/ring-light-glowing-webcam.mp4" poster="posts/hacking-a-cheap-ring-light-to-be-smart/ring-light-glowing-webcam-poster.jpg" />
...
<Video src="posts/hacking-a-cheap-ring-light-to-be-smart/ring-light-webcam-terminal.mp4" poster="posts/hacking-a-cheap-ring-light-to-be-smart/ring-light-webcam-terminal-poster.jpg" />
