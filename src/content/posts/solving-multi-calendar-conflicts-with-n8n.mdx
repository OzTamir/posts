...
featureImage: /content/images/posts/solving-multi-calendar-conflicts-with-n8n/featured.png
---
...
<Figure src="posts/solving-multi-calendar-conflicts-with-n8n/slack-reschedule-request.png" alt="" />
...
<Figure src="posts/solving-multi-calendar-conflicts-with-n8n/google-oauth-permission-screen.png" alt="" />
...
<Figure src="posts/solving-multi-calendar-conflicts-with-n8n/gcloud-oauth-client-list.png" alt="" />
...
<Figure src="posts/solving-multi-calendar-conflicts-with-n8n/n8n-calendar-credential-form.png" alt="" />
...
<Figure src="posts/solving-multi-calendar-conflicts-with-n8n/n8n-full-sync-workflow.png" alt="" />
...
<Figure src="posts/solving-multi-calendar-conflicts-with-n8n/n8n-get-events-node.png" alt="" />
...
<Figure src="posts/solving-multi-calendar-conflicts-with-n8n/n8n-cancelled-condition-node.png" alt="" />

Nothing fancy. If it’s no longer happening, it shouldn’t block time on the work side either.

<Figure src="posts/solving-multi-calendar-conflicts-with-n8n/n8n-delete-event-node.png" alt="" />
...
<Figure src="posts/solving-multi-calendar-conflicts-with-n8n/n8n-create-blocker-node.png" alt="" />
...
<Figure src="posts/solving-multi-calendar-conflicts-with-n8n/n8n-update-event-node.png" alt="" />
...
<Figure src="posts/solving-multi-calendar-conflicts-with-n8n/blocked-personal-event-result.png" alt="" />
