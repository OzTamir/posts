...
date: '2025-04-06T11:15:39.000Z'
updatedDate: '2026-06-18T23:46:02.000Z'
author: oz
description: Automating Social Checkups with n8n, Claude, and a WhatsApp MCP
image: featured.png
tags:
  - ai
  - agents
...
![](why-i-didnt-text-back.png)
*Many of my friends have got this image when I first [saw it on X](https://x.com/OzTamir/status/1880636601350725861)*
...
![](n8n-mcp-node-install-dialog.png)
...
![](n8n-mcp-community-node-installed.png)
...
![](whatsapp-bridge-qr-terminal.png)
*This QR code will let you log into my WhatsApp, you should scan it!*
...
![](whatsapp-mcp-credential-config.png)
...
![](n8n-agent-workflow-diagram.png)
