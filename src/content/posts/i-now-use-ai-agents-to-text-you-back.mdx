...
featureImage: /content/images/posts/i-now-use-ai-agents-to-text-you-back/featured.png
---
...
<Figure src="posts/i-now-use-ai-agents-to-text-you-back/why-i-didnt-text-back.png" alt="" caption={"<span style=\"white-space: pre-wrap;\">Many of my friends have got this image when I first </span><a href=\"https://x.com/OzTamir/status/1880636601350725861\" rel=\"noreferrer\"><span style=\"white-space: pre-wrap;\">saw it on X</span></a>"} />
...
<Figure src="posts/i-now-use-ai-agents-to-text-you-back/raspberry-pi-on-desk.png" alt="" />
...
<Figure src="posts/i-now-use-ai-agents-to-text-you-back/n8n-terminal-install.png" alt="" />
...
<Figure src="posts/i-now-use-ai-agents-to-text-you-back/n8n-mcp-node-install-dialog.png" alt="" />
...
<Figure src="posts/i-now-use-ai-agents-to-text-you-back/n8n-mcp-community-node-installed.png" alt="" />
...
<Figure src="posts/i-now-use-ai-agents-to-text-you-back/whatsapp-bridge-qr-terminal.png" alt="" caption={"<span style=\"white-space: pre-wrap;\">This QR code will let you log into my WhatsApp, you should scan it!</span>"} />
...
<Figure src="posts/i-now-use-ai-agents-to-text-you-back/whatsapp-mcp-demo.gif" alt="" />
...
<Figure src="posts/i-now-use-ai-agents-to-text-you-back/whatsapp-mcp-credential-config.png" alt="" />
...
<Figure src="posts/i-now-use-ai-agents-to-text-you-back/n8n-agent-workflow-diagram.png" alt="" />
...
<Figure src="posts/i-now-use-ai-agents-to-text-you-back/agent-chat-fetch-message.png" alt="" />
...
<Figure src="posts/i-now-use-ai-agents-to-text-you-back/agent-chat-priority-list.png" alt="" />
