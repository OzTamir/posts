...
pubDate: "2024-08-24T16:58:16.000Z"
...
author: oz
featured: false
excerpt: "How I used AI to write Broke: an NFC tag that blocks distractions, inspired by Brick."
featureImage: /content/images/2024/08/Brick-1.jpeg
---
...
<figure class="kg-card kg-image-card kg-card-hascaption">
  <img src="/content/images/2024/08/IMG_3457.jpeg" alt="It took multiple tries, but I'm really happy with the end product " width="2000" height="1500" loading="lazy" decoding="async">
  <figcaption><span style="white-space: pre-wrap;">It took multiple tries, but I'm really happy with the end product</span></figcaption>
</figure>
...
<figure class="kg-card kg-image-card">
  <img src="/content/images/2024/08/DraggedImage.png" alt="" width="1663" height="1053" loading="lazy" decoding="async">
</figure>

Working with Claude was great - I was quickly able to put a basic PoC that allowed me to demonstrate that the app worked.

<figure class="kg-card kg-image-card kg-card-hascaption">
  <img src="/content/images/2024/08/poc.png" alt="" width="496" height="511" loading="lazy" decoding="async">
  <figcaption><span style="white-space: pre-wrap;">The Proof of concept design</span></figcaption>
</figure>
...
<figure class="kg-card kg-image-card">
  <img src="/content/images/2024/08/Screenshot-2024-08-23-at-10.46.36.png" alt="" width="1916" height="840" loading="lazy" decoding="async">
</figure>
...
<figure class="kg-card kg-image-card">
  <img src="/content/images/2024/08/DraggedImage.492185d805134a97b29739c7e60516c9.png" alt="" width="633" height="471" loading="lazy" decoding="async">
</figure>

This is how the final experience looks like:

<figure class="kg-card kg-video-card">
  <video src="/content/media/2024/08/Broke.mp4" poster="/content/images/2024/08/Screenshot-2024-08-24-at-19.54.16.png" controls preload="metadata" playsinline style="width:100%"></video>
</figure>
