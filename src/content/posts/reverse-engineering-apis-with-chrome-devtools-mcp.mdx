...
featureImage: /content/images/posts/reverse-engineering-apis-with-chrome-devtools-mcp/featured.png
---
...
<Figure src="posts/reverse-engineering-apis-with-chrome-devtools-mcp/devtools-mcp-network-tools.png" alt="" />
...
<Figure src="posts/reverse-engineering-apis-with-chrome-devtools-mcp/token-limit-error.png" alt="" />
...
<Figure src="posts/reverse-engineering-apis-with-chrome-devtools-mcp/pagination-pr-merged.png" alt="" />
...
<Figure src="posts/reverse-engineering-apis-with-chrome-devtools-mcp/agent-network-inspection.png" alt="" />
...
<Figure src="posts/reverse-engineering-apis-with-chrome-devtools-mcp/discovered-api-endpoints.png" alt="" />

And once it had a clear enough picture, it went ahead and started generating the Python API client:

<Figure src="posts/reverse-engineering-apis-with-chrome-devtools-mcp/generated-python-client.png" alt="" />
