...
<figure class="kg-card kg-image-card kg-card-hascaption">
  <img src="/content/images/2023/03/res.png" alt="Final Result" width="1478" height="966" loading="lazy" decoding="async">
...
<figure class="kg-card kg-image-card">
  <img src="/content/images/2023/03/DraggedImage.png" alt="" loading="lazy" decoding="async">
</figure>

<figure class="kg-card kg-image-card">
  <img src="/content/images/2023/03/DraggedImage-1.png" alt="" loading="lazy" decoding="async">
</figure>

After setting it up and connecting it to WiFi, I could access the WebUI of WLED, which looked very easy to use:

<figure class="kg-card kg-image-card">
  <img src="/content/images/2023/03/DraggedImage-2.png" alt="" loading="lazy" decoding="async">
</figure>
...
<figure class="kg-card kg-image-card kg-card-hascaption">
  <img src="/content/images/2023/03/wire-1.png" alt="On the LED side - Black is GND, Red is 5v, and Green is GPIO (Data)" width="1524" height="1182" loading="lazy" decoding="async">
  <figcaption>On the LED side - White is GND, Red is 5v, and Green is GPIO (Data)</figcaption>
</figure>
...
<figure class="kg-card kg-image-card">
  <img src="/content/images/2023/03/image.png" alt="" width="347" height="336" loading="lazy" decoding="async">
</figure>
...
<figure class="kg-card kg-image-card">
  <img src="/content/images/2023/03/A9818548-B561-4BFA-9EF8-8969EBB7201F_1_105_c.jpeg" alt="" loading="lazy" decoding="async">
</figure>
...
<figure class="kg-card kg-image-card">
  <img src="/content/images/2023/03/12FF2559-A227-4EA2-87CA-C75785F9AF79_1_102_o.jpeg" alt="" loading="lazy" decoding="async">
</figure>
...
<figure class="kg-card kg-image-card kg-card-hascaption">
  <img src="/content/images/2023/03/Screenshot-2023-03-29-at-8.50.21.png" alt="Measuring..." width="669" height="374" loading="lazy" decoding="async">
  <figcaption>Measuring...</figcaption>
</figure>

<figure class="kg-card kg-image-card kg-card-hascaption">
  <img src="/content/images/2023/03/DraggedImage-3.png" alt="Modeling..." loading="lazy" decoding="async">
  <figcaption>Modeling...</figcaption>
</figure>

<figure class="kg-card kg-image-card kg-card-hascaption">
  <img src="/content/images/2023/03/DraggedImage-4.png" alt="Printing..." loading="lazy" decoding="async">
  <figcaption>Printing...</figcaption>
</figure>

<figure class="kg-card kg-image-card kg-card-hascaption">
  <img src="/content/images/2023/03/3011BACD-E50F-4F4C-8909-4AE6A6493B60_1_105_c.jpeg" alt="Connecting!" loading="lazy" decoding="async">
...
<figure class="kg-card kg-image-card">
  <img src="/content/images/2023/03/Screenshot-2023-03-28-at-23.41.15-1.png" alt="" width="922" height="358" loading="lazy" decoding="async">
</figure>

And that was it. I was very happy with the result, and I enjoyed the various effects supported by WLED:

<figure class="kg-card kg-image-card">
  <img src="/content/images/2023/03/IMG_5774.gif" alt="" loading="lazy" decoding="async">
</figure>
...
<figure class="kg-card kg-image-card">
  <img src="/content/images/2023/03/9442A463-1EBC-4E4D-935C-017715E973A9_1_105_c.jpeg" alt="" loading="lazy" decoding="async">
</figure>

Again, the next step was to make sure everything looked right on the settings page, under Sound Settings in the WebUI:

<figure class="kg-card kg-image-card">
  <img src="/content/images/2023/03/image-1.png" alt="" width="1087" height="516" loading="lazy" decoding="async">
</figure>
...
<figure class="kg-card kg-video-card">
  <video src="/content/media/2023/03/IMG_4798.mp4" poster="/content/images/2023/03/media-thumbnail-ember180.jpg" controls preload="metadata" playsinline style="width:100%"></video>
</figure>
