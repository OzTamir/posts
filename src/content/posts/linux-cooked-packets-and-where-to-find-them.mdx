...
featureImage: /content/images/posts/linux-cooked-packets-and-where-to-find-them/featured.png
...
<Figure src="posts/linux-cooked-packets-and-where-to-find-them/sll-packet-type-description.png" alt="" />
...
<Figure src="posts/linux-cooked-packets-and-where-to-find-them/tcpdump-any-interface-capture.png" alt="" caption={"<code>tcpdump -i any -w sniff.pcap port 4590</code>"} />

Now, let’s take a look at the resulting PCAP file using our favourite packet analyser, Wireshark:

<Figure src="posts/linux-cooked-packets-and-where-to-find-them/wireshark-linux-cooked-frame.png" alt="" />
