...
<Figure src="2020/07/image-3.png" alt="" />
...
<Figure src="2020/07/Screen-Shot-2020-07-29-at-19.16.23-1.png" alt="" caption={"<code>tcpdump -i any -w sniff.pcap port 4590</code>"} />

Now, let’s take a look at the resulting PCAP file using our favourite packet analyser, Wireshark:

<Figure src="2020/07/DraggedImage-8.png" alt="" />
