...
featureImage: /content/images/posts/putting-an-end-to-3d-printed-halloween-models/featured.png
---
...
<Figure src="posts/putting-an-end-to-3d-printed-halloween-models/printables-halloween-models-grid.png" alt="" />
...
<Figure src="posts/putting-an-end-to-3d-printed-halloween-models/extension-icon-halloween-filter.png" alt="" caption={"<span style=\"white-space: pre-wrap;\">The icon ChatGPT helped me create</span>"} />
...
<Figure src="posts/putting-an-end-to-3d-printed-halloween-models/extension-settings-keyword-list.png" alt="" />
...
<Figure src="posts/putting-an-end-to-3d-printed-halloween-models/printables-art-models-no-halloween.png" alt="Same page - with FHM extension enabled" caption={"<span style=\"white-space: pre-wrap;\">Same page - with FHM extension enabled</span>"} />
