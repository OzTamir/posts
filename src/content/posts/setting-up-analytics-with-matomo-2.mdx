...
featureImage: /content/images/posts/setting-up-analytics-with-matomo-2/featured.png
---
...
<Figure src="posts/setting-up-analytics-with-matomo-2/visitor-profile-detail.png" alt="" />
...
<Figure src="posts/setting-up-analytics-with-matomo-2/matomo-homepage.png" alt="https://matomo.org/" caption="https://matomo.org/" />
...
<Figure src="posts/setting-up-analytics-with-matomo-2/anonymize-tracking-settings.png" alt="Yes, these are the actual settings from this site's analytics control panel 🙂" caption="Yes, these are the actual settings from this site's analytics control panel 🙂" />
